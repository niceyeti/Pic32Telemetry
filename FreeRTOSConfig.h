...
//#define configMINIMAL_STACK_SIZE				( 190 )  //original val: afraid comm proc using more stack
#define configMINIMAL_STACK_SIZE				( 300 )    // 300 * word size = 32 bits, ==> stack is 1200 bytes
